...
|----|--------|------------|
|<sub>[header.test.tsx](https://github.com/1dv611-futurum-project/futurum-project/blob/master/services/client/test/components/header.test.tsx)</sub>|<sub>#7</sub>|<sub><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Yes_Check_Circle.svg/2000px-Yes_Check_Circle.svg.png" width="15"></sub>|
|<sub>[ticket.test.tsx](https://github.com/1dv611-futurum-project/futurum-project/blob/master/services/client/test/components/ticket.test.tsx)</sub>|<sub>#13</sub>|<sub><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Yes_Check_Circle.svg/2000px-Yes_Check_Circle.svg.png" width="15"></sub>|
|<sub>[statusSelect.test.tsx](https://github.com/1dv611-futurum-project/futurum-project/blob/master/services/client/test/components/statusSelect.test.tsx)</sub>|<sub>#15</sub>|<sub><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Yes_Check_Circle.svg/2000px-Yes_Check_Circle.svg.png" width="15"></sub>|
